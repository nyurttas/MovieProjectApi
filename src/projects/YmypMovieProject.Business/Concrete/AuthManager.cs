    ...
    public class AuthManager : IAuthService
    {
        ...
        public IDataResult<User> Login(UserForLoginDto userForLoginDto)
        {
           var user = _userService.GetByMail(userForLoginDto.Email);
            if (user == null)
            {
                return new ErrorDataResult<User>(ResultMessages.ErrorGetUser);
            }
        ...
        public IDataResult<User> Register(UserForRegisterDto userForRegisterDto)
        {
            ...
            return new SuccessDataResult<User>(user, ResultMessages.SuccessCreated);
        ...
        public IResult UserExists(string email)
        {
          if (_userService.GetByMail(email).Data != null)
            {
                return new ErrorResult(ResultMessages.SuccessUserExist);
            }
