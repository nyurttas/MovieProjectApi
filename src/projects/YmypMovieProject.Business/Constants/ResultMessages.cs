...
public static class ResultMessages
{
    ...
    public static string ErrorUserExists ="Bu e-posta adresi kayıtlı değil.";
    public static string SuccessUserExist = "Bu e-posta adresi zaten kayıtlı";
    public static string ErrorGetUser = "Kullanıcı bulunamadı.";
